...
| ---- | ---- | ---- |
| Vault package | `test_audit_schema.py`, `test_auth.py`, `test_calibration.py`, `test_embedding_settings.py`, `test_embedding_text.py`, `test_embeddings_openai.py`, `test_facets.py`, `test_governance.py`, `test_read_policy.py`, `test_repositories.py`, `test_search.py`, `test_settings.py` | Move and repoint package imports. Replace the root `configure_test_env` dependency with a package-owned database URL fixture. |
