...
| B: Human service boundary (B1–B3 built 2026-09-12, ADRs [0049](adr/0049-the-human-collection-boundary.md), [0050](adr/0050-human-reads-the-audience-is-the-collection.md) and [0051](adr/0051-human-writes-are-revision-checked-and-retry-safe.md)) | Reviewed migrations, role/verb scopes, Human reads/writes/history, deletion/tombstones, resource revisions and change feed | Scope/ownership matrix tests, cursor/retry/concurrency tests, no Agent read disclosure of hidden Human content |
