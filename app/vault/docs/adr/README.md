...
| 0048 | [Human notes are database-owned and Obsidian is an OAuth sync client](0048-human-vault-database-authority-and-obsidian-sync.md) | Accepted direction, implementation pending |
